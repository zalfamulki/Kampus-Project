...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Daftarkan tenaga pengajar baru.</p>
        </div>
    ...
    <div class="card-table">
        <form action="{{ route('dosen.store') }}" method="POST" class="form-academic">
            @csrf
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="text" name="nidn" id="nidn" value="{{ old('nidn') }}" required />
            </div>
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="text" name="nama" id="nama" value="{{ old('nama') }}" required />
            </div>
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="text" name="departemen" id="departemen" value="{{ old('departemen') }}" />
            </div>
