...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Perbarui kurikulum mata kuliah: <strong>{{ $matkul->nama }}</strong></p>
        </div>
    ...
    <div class="card-table">
        <form action="{{ route('matkul.update', $matkul) }}" method="POST" class="form-academic">
            @csrf
            @method('PUT')
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="text" name="kode" id="kode" value="{{ old('kode', $matkul->kode) }}" required />
            </div>
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="text" name="nama" id="nama" value="{{ old('nama', $matkul->nama) }}" required />
            </div>
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="number" name="sks" id="sks" value="{{ old('sks', $matkul->sks) }}" required />
            </div>
            ...
            <div class="form__row">
                ...
                <input class="form__input" type="number" name="semester" id="semester" value="{{ old('semester', $matkul->semester) }}" required />
            </div>
